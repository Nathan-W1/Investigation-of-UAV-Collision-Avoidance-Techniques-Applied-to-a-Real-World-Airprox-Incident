function pathPlan = planIFDSstatic(rho0,sig0);
...
while distanceCost(pos, goal) > threshold
        ...
        shortestDistance = min(tempD);
        
        if shortestDistance < closestCall
            closestCall = shortestDistance;
        end
        ...
        adjustedTime = 0.2*round(realTime/0.2);
        pos = nextPos;
...
pathPlan.adjustedTime = adjustedTime;
